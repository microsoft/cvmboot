...
#ifndef _CVMBOOT_BOOTLOADER_TPM2_H
#define _CVMBOOT_BOOTLOADER_TPM2_H
...
static inline void TPMS_PCR_SELECTION_SelectPCR(
...
TPM_RC TPM2X_BuildPolicy(
    ...
    IN UINT32 pcrMask,
    IN const sha256_t pcrs[MAX_PCRS], /* Unused if !predictive */
    TPMI_ALG_HASH hashAlg,
    err_t* err);
...
TPM_RC TPM2X_Seal(
    ...
    IN BOOLEAN predictive,
    IN UINT32 pcrMask,
    IN const sha256_t pcrs[MAX_PCRS],
...
#endif /* _CVMBOOT_BOOTLOADER_TPM2_H */
